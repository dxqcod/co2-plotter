...
Проект представляет собой простой самописец (ретро-стиль) для измерения концентрации CO₂ в помещении на базе датчика MH-Z19 и контроллера Arduino.  
Работа основана на школьной исследовательской работе 2018 года (документ прилагается).


<p align="center">
  <a href="docs/photos/2.jpg">
    <img src="docs/photos/2.jpg" width="400" />
  </a>
</p>
